...
namespace WayFinder.Migrations
{
    ...
    [Migration("20260904195913_Agregar_IndiceUnico_Eventos")]
    partial class Agregar_IndiceUnico_Eventos
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WayFinder.DestinosTuristicos.ExperienciaViaje", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("WayFinder.DestinosTuristicos.ListaSeguimiento", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("WayFinder.Eventos.Evento", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("WayFinder.MetricaApi", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppMetricaApis", (string)null);
                });

            modelBuilder.Entity("WayFinder.Notificacion", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("WayFinder.Perfiles.PerfilUsuario", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.OwnsOne("WayFinder.DestinosTuristicos.Coordenadas", "Coordenadas", b1 =>
                        {
                            ...
                            b1.Property<double>("latitud")
                                .HasColumnType("float")
                                .HasColumnName("coordenadas_latitud");
