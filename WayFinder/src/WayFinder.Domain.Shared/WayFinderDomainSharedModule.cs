...
public class WayFinderDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        WayFinderGlobalFeatureConfigurator.Configure();
        WayFinderModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<WayFinderDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<WayFinderResource>("es")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/WayFinder");

            options.DefaultResourceType = typeof(WayFinderResource);
        ...
        {
            options.MapCodeNamespace("WayFinder", typeof(WayFinderResource));
        });
    }
}
